...
import com.google.claywilkinson.videorecord.R;
...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  public Frame onDrawFrame(SampleRender render, Frame currentFrame) {
    ...
    Frame frame;
    try {
      frame = currentFrame != null ? currentFrame : session.update();
    } catch (CameraNotAvailableException e) {
  ...
  public void clickToggleRecording(View view) {
    ...
    updateControls(render.toggleRecording());
  }

  private void updateControls(boolean recording) {
    Button toggleRelease = findViewById(R.id.record_button);
    int id = (recording) ?
